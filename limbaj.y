...
%token <dataType> INTTYPE BOOLTYPE STRINGTYPE ARRAYTYPE CHARTYPE STRUCTCALL
%token <intVal> NR
...
structure      : STRUCTCALL ID { insert($1, $2, 0); addRefference($2); } LBRACKET { increaseDepth(); } declarations { decreaseDepth(); removeRefference(); } RBRACKET
               ;
